...
foreach(['contact_messages',"'schema_version' => '9'",'idx_contact_message_site_status','asyura_human_daily'] as $needle){if(!str_contains($migration,$needle)){fwrite(STDERR,"FAIL inquiry migration missing: {$needle}\n");$failed++;}}
...
foreach(['sort_order','idx_sites_sort',"'schema_version' => '9'"] as $needle){if(!str_contains($migration,$needle)){fwrite(STDERR,"FAIL site order migration missing: {$needle}\n");$failed++;}}
